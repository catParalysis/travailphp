<?php
/* ici je fait un form de modifications, je le popule avec ce qui viens de la base de donnée alors c'est pour ca que j'utilise htmlspecialchars , ent_quotes */
